...
* Адапатация работы с UI Automation в интерфейсе 8.5 #2375
...
* Опитимизация работы некоторых шагов. Отказ от использования Ванесса.Шаг() #2376
* Определение, что сеанс клиента тестирования завершен нештатно #2396
...
* По-разному отрабатывают шаги проверки строк таблицы в зависимости от регистра #2349 Cпасибо @Reheab
...
* Не правильно работает сборка HTML (В цикле читаем таблицу и вставляем произвольный текст, для всех шагов выводится один и тот же текст #2328 Спасибо @StS-testim
...
* Проблема с потерей кеша шагов, которые встроенны в конфигурацию #2407
...
* Некорректно обрабатывалось событие перезапуска клиента тестирования и запуск упавшего сценария ешё раз #2409

...
| **frequently_used_steps** | Возвращает информацию о том какие шаги чаще используются статистике больших проектов. В начале идут часто используемые шаги, далее идут более редко используемые шаги. Возвращает представление шага, описание шага, тип шага. Также возвращает информацию сколько всего шагов есть в накопленной статистике. |

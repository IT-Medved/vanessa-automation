...
2. **Установите расширение в базу менеджера тестирования**. В базу менеджера тестирования необходимо поставить расширение из [инструкции](https://github.com/Pr-Mex/vanessa-automation/blob/develop/docs/AI/index.md).

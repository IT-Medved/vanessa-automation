...
1.Исследование.md      →  Выполнение сценария вручную и сбор информации
         ↓
2.Сценарий.MD          →  Написание и отлада сценария
```

...
Сценарий: Клик в прикрепленную панель функций
	...
	//Нужно, если было несколько запуска этого сценария
	Если 'КонтекстСохраняемый.Свойство("ИмяПрофиляТестПанельФункций")' Тогда
		Дано Я удаляю пользователя "$$ИмяПрофиляТестПанельФункций$$"

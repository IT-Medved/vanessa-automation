...
Сценарий: Передача параметра во вложенный сценарий так, чтобы происходила передача параметра внутрь многострочного параметра в квадратрых скобках. Оба парсера.

	* Старый парсер
		* Загрузка служебной фичи
			Когда В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "Подсценарии\ПараметрВнтуриПараметра02"
		...
		* Проверка результата	
			Тогда в логе сообщений TestClient есть строки:
				| 'Часть1Значение01Часть2' |
				| 'Часть3Значение01Часть4' |
			
	* Новый парсер
		* Загрузка служебной фичи
			И я очищаю окно сообщений пользователю
			Когда В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "Подсценарии\ПараметрВнтуриПараметра03"

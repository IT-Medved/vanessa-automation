...
Сценарий: Проверка таблицы перевода. Загрузка фичи на другом языке. Старый парсер.
	Когда Я открываю VanessaAutomation в режиме TestClient со стандартной библиотекой
	...
	Если в логе сообщений TestClient есть строки Тогда
		|'Не получилось поменять параметры шага местами'|

		Тогда я вызываю исключение "Ошибка перестановки параметров."



Сценарий: Проверка таблицы перевода. Загрузка фичи на другом языке. Старый парсер. Часть2.
	Когда Я открываю VanessaAutomation в режиме TestClient со стандартной библиотекой
	
	Когда В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "СлужебнаяФичаEN9"
	...
	Тогда таблица "ДеревоТестов" стала равной:
		| 'Наименование'                                                   |
		| 'СлужебнаяФичаEN9.feature'                                       |
		| 'СлужебнаяФичаEN9'                                               |
		| 'СлужебнаяФичаEN9'                                               |
		| 'When I connect TestClient with parameters'                      |
		| '\| \'Имя\'         \| \'Синоним\'        \| \'Тип клиента\' \|' |
		| '\| \'ИмяПрофиля1\' \| \'СинонимПрофиля\' \| \'Тонкий\'      \|' |
	
		

Сценарий: Проверка таблицы перевода. Загрузка фичи на другом языке. Новый парсер.
	Когда Я открываю VanessaAutomation в режиме TestClient со стандартной библиотекой

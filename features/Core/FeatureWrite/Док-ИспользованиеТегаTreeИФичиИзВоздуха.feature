...
Сценарий: Написание требований бизнес аналитиком и их детализация
	...
	И видеовставка 'видеовставка. Для экономии времени на разработку, часть шагов фичи можно накликать мышкой.'		
	И видеовставка 'Давайте сделаем это и постараемся сохранить читаемость фича файла. Для этого мы указали в тексте тэг tree.'		
	...
	Накликаем функционал создания документа прихода
			...
			И видеовставка 'При нажатии на эту кнопку открылся сеанс с ключом запуска /TestClient'		
			И я разворачиваю активное окно на полный экран
	...
	И видеовставка 'Мы получили готовые шаги сценария с помощью мышки. Этот механизм называется: Фичи из воздуха.'
	...
	Теперь загрузим нашу фичу в Vanessa-Behavior и выполним её
			...
			И видеовставка 'видеовставка. Часть шагов стала ветками дерева. Такие шаги выполнятся не будут.'		
			И я прижимаю активное окно влево
			И я выполняю сценарии и ожидаю их окончания в сеансе служебной базы
			И видеовставка 'Таким образом нам осталось запрограммировать только последний шаг.'

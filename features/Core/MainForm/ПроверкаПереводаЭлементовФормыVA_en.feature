...
Сценарий: Проверка перевода элементов формы VA en
	...
	И я генерирую код для создания перменной в сеансе VA для проверки РасширеннойПодсказки и сохраняю его в переменную "ИменаЭлементовСРасширеннойПодсказкойМенеджер"
	...
	И в поле с именем 'РеквизитПроизвольныйКод' я ввожу текст '$ИменаЭлементовСРасширеннойПодсказкойМенеджер$'
	И я перехожу к следующему реквизиту
	И я нажимаю на кнопку с именем 'ВыполнитьПроизвольныйКод'
	И Пауза 1
	
	И я нажимаю на кнопку с именем 'ПроверкаПереводаЭлементовФормы'
	И Пауза 3

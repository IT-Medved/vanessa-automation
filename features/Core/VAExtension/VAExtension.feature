...
Сценарий: Сохранение ссылки на объект в переменную и открытие ссылки
	...
	* Создание элемента
		...
		И в поле с именем 'Наименование' я ввожу текст "ТестРаботыСсылкой"
		И я перехожу к следующему реквизиту
		И я нажимаю на кнопку с именем 'ФормаЗаписать'
		И Пауза 1
		
	* Сохранение ссылки в переменную
		И я сохраняю ссылку на объект из текущего окна в переменную "Ссылка1"	
		И я сохраняю строковое представление ссылки на объект из текущего окна в переменную "Ссылка2"
	* Проверка
		И я закрываю все окна клиентского приложения
		И я открываю объект по ссылке "Ссылка1" (расширение)
		Тогда открылось окно 'ТестРаботыСсылкой (Справочник1)'		

		И я закрываю все окна клиентского приложения
		И я открываю объект по строковому представлению ссылки "Ссылка2" (расширение)
		Тогда открылось окно 'ТестРаботыСсылкой (Справочник1)'		
...
Сценарий: Основная проверка VAExtension
	...
	* Проверка открытия внешнего отчета
		И я открываю внешнюю обработку или отчет "$КаталогИнструментов$\lib\ExternalReport\ТестовыйВнешнийОтчет.erf" (Расширение)
		Тогда открылось окно 'Тестовый внешний отчет'
		И Я закрываю окно 'Тестовый внешний отчет'

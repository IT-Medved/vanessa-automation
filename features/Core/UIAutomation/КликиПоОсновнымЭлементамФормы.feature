...
Сценарий: Проверка поиска основных элементов формы с помощью механизма UI Automation
	...
	И я запоминаю значение настройки Vanessa Automation "ДелатьЛогВыполненияСценариевВЖР" в "ДелатьЛогВыполненияСценариевВЖР"
	И я устанавливаю флаг настройки Vanessa Automation "ДелатьЛогВыполненияСценариевВЖР"
	...
	И Я нажимаю на кнопку выполнить сценарии в Vanessa-Automation TestClient 700
	...
	Тогда таблица "ДеревоТестов" стала равной:
		...
		| '* Проверка рисования рамки по элементам, когда данные переданы через переменную секции переменные'                                                           | ''        |
		| 'И я читаю данные текущего профиля клиента тестирования'                                                                                                      | 'Success' |
		| 'И я рисую рамку вокруг элементов формы UI Automation "$PIDКлиентаТестирования$"'                                                                             | 'Success' |
		| '\| \'Имя/ID\'                    \| \'Тип\'        \|'                                                                                                       | ''        |
		| '\| \'__Таб_ВыделенияГруппой_01\' \| \'Переменная\' \|'                                                                                                       | ''        |
		| 'И Пауза 3'                                                                                                                                                   | 'Success' |
	...
	Если 'Контекст.ДелатьЛогВыполненияСценариевВЖР' тогда
		И я устанавливаю флаг настройки Vanessa Automation "ДелатьЛогВыполненияСценариевВЖР"
	Иначе	
		И я снимаю флаг настройки Vanessa Automation "ДелатьЛогВыполненияСценариевВЖР"

...
//https://github.com/Pr-Mex/vanessa-automation/issues/2523
Сценарий: Формирование jUnit когда сценарию идёт установка Skipped
	* Подготовка
		Когда В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "jUnit\ФичаДляПроверкиОтчетаjUnit9"
	...
	* Проверка	
		...
		И для каждого файла "ТекущийФайл" из каталога "$КаталогВыгрузкиJUnit$"
			...
			И выражение внутреннего языка 'Найти($ТекстФайла$, "<skipped/>") > 0' Истинно

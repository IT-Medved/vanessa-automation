...
Сценарий: Проверка отчета Markdown. Проверка директивы autodoc.ignorestep
		Когда Я открываю VanessaAutomation в режиме TestClient со стандартной библиотекой
		И В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "Markdown/ПроверкаИнструкцииMarkdown04"
		...
		И я устанавливаю флаг с именем 'АвтонумерацияШагов'

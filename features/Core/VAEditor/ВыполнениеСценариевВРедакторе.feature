...
//https://github.com/Pr-Mex/vanessa-automation/issues/2379	
Сценарий: Проверка выполнения одной строки по F11, когда это подсценарий и внутри происходит прерывание цикла
	* Загрузка служебной фичи	
		И я перехожу в редактор Vanessa Automation из дерева

		И я перехожу к закладке с именем "ГруппаСлужебная"
		Когда В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "VAEditor/VanessaEditor60"
	...
	* Проверка результата
		...
		//Шаг "И пауза 1" не должен выполниться, а остальные шаги подсценария должны
		Тогда таблица 'ДеревоТестов' стала равной:
			| 'Наименование'                 | 'Статус'  |
			| 'VanessaEditor60.feature'      | ''        |
			| 'VAEditor60'                   | ''        |
			| 'VAEditor60'                   | ''        |
			| 'И Пауза 1'                    | ''        |
			| 'И ДляПроверкиЦикловЭкспорт01' | ''        |
...
Сценарий: Выполнить один шаг, когда текущий внутри условия, а следующая строка группа перед строкой Иначе
	* Загрузка служебной фичи	
		И я перехожу в редактор Vanessa Automation из дерева

		И я перехожу к закладке с именем "ГруппаСлужебная"
		Когда В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "VAEditor/VanessaEditor58"
		И Я нажимаю на кнопку перезагрузить сценарии в Vanessa-Automation TestClient
...
Сценарий: Выполнить один шаг, когда текущий шаг это обычный шаг, а следующий шаг находится в попытке
	...
	* Установка нужной строки текущей.
		И я перехожу к закладке с именем "ГруппаСлужебная"
		И я перехожу к закладке с именем "ГруппаСлужебноеВыполнитьКод"
		И в поле с именем 'РеквизитПроизвольныйКод' я ввожу текст 'VanessaTabs.current.editor.setPosition(11, 1, \"\");'
		И я нажимаю на кнопку с именем 'ВыполнитьПроизвольныйКод'
		И пауза 1
		И я перехожу к закладке с именем "ГруппаЗапускТестов"
...
Сценарий: Выполнить один шаг, когда это шаг подсценария и была ошибка актвизации строки другого подсценария
	* Загрузка служебной фичи	
		...
		И я перехожу к закладке с именем "ГруппаСлужебная"
		Когда В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "VAEditor/VanessaEditor50"
		И Я нажимаю на кнопку перезагрузить сценарии в Vanessa-Automation TestClient
	...
	* Переход к нужной строке сценария
		И я перехожу к закладке с именем "ГруппаСлужебная"
		И я перехожу к закладке с именем "ГруппаСлужебноеВыполнитьКод"
		И в поле с именем 'РеквизитПроизвольныйКод' я ввожу текст 'VanessaTabs.current.editor.selectSubcodeLine("b3", 21);'
		И я нажимаю на кнопку с именем 'ВыполнитьПроизвольныйКод'
		И Пауза 2
		И я перехожу к закладке с именем "ГруппаЗапускТестов"
		И Пауза 2
	...
	* Проверка результата
		...
		И в таблице 'ТаблоПеременных' я перехожу к строке:
			| "Значение" | "Имя"           | "Тип"   |
			| "6"        | "ИмяПеременной" | "Число" |
		



Сценарий: Выполнить один шаг, когда это шаги условия'
	...
	* Загрузка служебной фичи	
		...
		И я перехожу к закладке с именем "ГруппаСлужебная"
		Когда В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "VAEditor/VanessaEditor49"
		И Я нажимаю на кнопку перезагрузить сценарии в Vanessa-Automation TestClient
...
Сценарий: Выполнить один шаг, когда это подсценарий в секции Контекст
	...
	* Загрузка служебной фичи	
		...
		И я перехожу к закладке с именем "ГруппаСлужебная"
		Когда В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "VAEditor/VanessaEditor48"
		И Я нажимаю на кнопку перезагрузить сценарии в Vanessa-Automation TestClient

	* Установка нужной строки текущей. Перед последней строкой сценария.
		И я перехожу к закладке с именем "ГруппаСлужебная"
		И я перехожу к закладке с именем "ГруппаСлужебноеВыполнитьКод"
		И в поле с именем 'РеквизитПроизвольныйКод' я ввожу текст 'VanessaTabs.current.editor.setPosition(10, 1, \"\");'
		И я нажимаю на кнопку с именем 'ВыполнитьПроизвольныйКод'
		И пауза 1
		И я перехожу к закладке с именем "ГруппаЗапускТестов"
	...
	* Проверка результата
		...
		Тогда таблица "ДеревоТестов" стала равной:
			| 'Наименование'                                                                                          | 'Статус'  |
			| 'VanessaEditor48.feature'                                                                               | ''        |
			| 'VAEditor48'                                                                                            | ''        |
			| 'Контекст'                                                                                              | ''        |
			| 'И ТестовыйСценарий48'                                                                                  | ''        |
			| 'Если не существует переменная "Счетчик" Тогда'                                                         | 'Success' |
			| 'И Я запоминаю значение выражения \'0\' в переменную "Счетчик" глобально'                               | 'Success' |
			| 'И Я запоминаю значение выражения \'КонтекстСохраняемый.Счетчик + 1\' в переменную "Счетчик" глобально' | 'Success' |
...
Сценарий: Выполнить один шаг, когда это подсценарий внутри условия
	...
	* Загрузка служебной фичи	
		...
		И я перехожу к закладке с именем "ГруппаСлужебная"
		Когда В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "VAEditor/VanessaEditor40"
		И Я нажимаю на кнопку перезагрузить сценарии в Vanessa-Automation TestClient
...
//https://github.com/Pr-Mex/vanessa-automation/issues/2147
Сценарий: Выполнить с текущего шага, когда происходит выполнение со строки подсценария, когда в подцесценарии есть попытка/исключение
	...
	* Загрузка служебной фичи	
		...
		И я перехожу к закладке с именем "ГруппаСлужебная"
		Когда В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "VAEditor/VanessaEditor52"
		И Я нажимаю на кнопку перезагрузить сценарии в Vanessa-Automation TestClient
...
Сценарий: Выполнить один шаг, когда это шаг подсценария и он не вызывает исключение
	...
	* Переход к нужной строке сценария
		И я перехожу к закладке с именем "ГруппаСлужебная"
		И я перехожу к закладке с именем "ГруппаСлужебноеВыполнитьКод"
		И в поле с именем 'РеквизитПроизвольныйКод' я ввожу текст 'VanessaTabs.current.editor.setPosition(24, 1, \"\");'
		И я нажимаю на кнопку с именем 'ВыполнитьПроизвольныйКод'
		И пауза 1
		И я перехожу к закладке с именем "ГруппаЗапускТестов"
...
Сценарий: Выполнить один шаг, когда это простой шаг, когда это шаг подсценария и он вызывает исключение
	...
	* Переход к нужной строке сценария
		И я перехожу к закладке с именем "ГруппаСлужебная"
		И я перехожу к закладке с именем "ГруппаСлужебноеВыполнитьКод"
		И в поле с именем 'РеквизитПроизвольныйКод' я ввожу текст 'VanessaTabs.current.editor.setPosition(29, 1, \"\");'
		И я нажимаю на кнопку с именем 'ВыполнитьПроизвольныйКод'
		И пауза 1
		И я перехожу к закладке с именем "ГруппаЗапускТестов"
...
Сценарий: Выполнить выделенные строки, когда выделенные номера строк совпадают с номерами строк подсценариев
	...
	* Выделение первых двух строк второго сценария
		И я перехожу к закладке с именем "ГруппаСлужебная"
		И я перехожу к закладке с именем "ГруппаСлужебноеВыполнитьКод"
		И в поле с именем 'РеквизитПроизвольныйКод' я ввожу текст 'VanessaTabs.current.editor.setSelection(18,1,19,40);'
		И я нажимаю на кнопку с именем 'ВыполнитьПроизвольныйКод'
		И Пауза 1
		И я перехожу к закладке с именем "ГруппаЗапускТестов"
...
Сценарий: Выполнить выделенные строки
	...
	* Выделение первых двух строк второго сценария
		И я перехожу к закладке с именем "ГруппаСлужебная"
		И я перехожу к закладке с именем "ГруппаСлужебноеВыполнитьКод"
		И в поле с именем 'РеквизитПроизвольныйКод' я ввожу текст 'VanessaTabs.current.editor.setSelection(22,1,25,40);'
		И я нажимаю на кнопку с именем 'ВыполнитьПроизвольныйКод'
		И Пауза 1
		И я перехожу к закладке с именем "ГруппаЗапускТестов"

...
Сценарий: Проверка расшифровки табличного документа
	...
	Если версия платформы ">=" "8.3.25" Тогда
		...
		И в табличном документе "Результат" я перехожу к ячейке содержащей текст "000000001"
		И Пауза 1
		...
		И Пауза 1
		И в табличном документе 'Результат' в меню расшифровки я выбираю 'Код'
		И Пауза 1
		Тогда элемент формы 'Группировка' стал равен "Код"

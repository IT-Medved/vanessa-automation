...
Сценарий: Запуск тонкого TestClient из толстого TestManager
	...
	И в поле с именем 'КоличествоСекундПоискаОкна' я ввожу текст '50'
	И в поле с именем 'КоличествоПопытокВыполненияДействия' я ввожу текст '10'
	И в поле с именем 'ТаймаутДляАсинхронныхШагов' я ввожу текст '600'

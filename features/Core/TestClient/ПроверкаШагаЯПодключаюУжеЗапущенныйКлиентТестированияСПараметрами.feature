...
Сценарий: Проверка подключения шага: Я подключаю уже запущенный клиент тестирования 
	...
	*Проверка ещё одного шага, который подключает уже запущенный клиент тестирования в течение указанного числа секунд
		И я очищаю окно сообщений пользователю
		И я перехожу к закладке с именем 'ГруппаНесколькоКлиентовТестирования'
		И в таблице 'ДанныеКлиентовТестирования' я нажимаю на кнопку с именем 'ТестКлиентОтключить'
		И Пауза 3
		И В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "ФичаДляПроверкиПодключенияЗапущенногоTestClient5"
		И Я нажимаю на кнопку перезагрузить сценарии в Vanessa-Automation TestClient
		И Я нажимаю на кнопку выполнить сценарии в Vanessa-Automation TestClient

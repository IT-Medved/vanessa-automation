...
Сценарий: Проверка генерации шагов инструментом ПодготовкаИЗагрузкаДанных
	...
	Допустим я меняю значение переключателя с именем 'StepsLanguage' на 'Русский'
	...
	И я нажимаю на кнопку с именем '*GenerateFeature*'
	И я меняю значение переключателя с именем 'StepsLanguage' на 'Русский'
	И я нажимаю на кнопку с именем '*GenerateFeature*'
...
Сценарий: Выгрузка объекта с реквизитом ХранилищеЗначения
	...
	* И протестируем загрузку
		...
		Тогда не существует элемент справочника "Товары" с "Наименование" равным "Тестовая"

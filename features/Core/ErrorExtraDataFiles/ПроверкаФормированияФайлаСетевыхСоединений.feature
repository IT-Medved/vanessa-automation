...
Функциональность: Проверка формирования файла сетевых соединений



	
Сценарий: Проверка формирования файла сетевых соединений
	...
	И я устанавливаю флаг с именем 'СобиратьДанныеОСетевыхСоединениях'
	...
	И я загружаю служебную фичу и устанавливаю настройки
			И В поле с именем "КаталогФичСлужебный" я указываю путь к служебной фиче "ErrorExtraDataFiles/ErrorExtraDataFiles01"
...
Сценарий: Закрытие сеанса TestManager. Проверка формирования файла сетевых соединений.

...
Сценарий: Работа с переменной "Контекст"
	...
	И видеовставка 'видеовставка, что во втором сценарии содержимое переменной Контекст стало пустым'
	И видеовставка 'А содержимое переменной КонтекстСохраняемый осталось прежним'
	И видеовставка 'Итого. Переменная Контекст очищается перед выполнением каждого сценария.'
	И видеовставка 'А КонтекстСохраняемый существует, пока открыта форма Vanessa-Behavior.'

...
Сценарий: Генерация нового EPF по feature файлу и перегенерация после добавления новых шагов
	...
	видеовставка. Для каждого из трёх шагов сценария было создано по одной процедуре.
	...
	Теперь посмотрим что изменилось в модуле обработки
			...
			И видеовставка "видеовставка: чтобы увидеть изменения в epf надо переоткрыть файл обработки."
	...
	И видеовставка 'видеовставка: процедура "ЯПолучуСуммуСлагаемых(Парам01)" осталась в модуле.'
	И видеовставка 'И появилась новая процедура "СуммаБудетМеньше(Парам01)"'
	И я перехожу к процедуре "СуммаБудетМеньше"
	И видеовставка 'Таким образом добавление шага в feature файл вызвало добавление процедуры в epf файл.'

...
Сценарий: Открыть фича файл в проводнике.
	...
	И я открываю выпадающий список с именем 'КомандаОткрытияФичиВТекстовомРедакторе'
	Если выпадающий список с именем 'КомандаОткрытияФичиВТекстовомРедакторе' содержит значения Тогда
		| 'Notepad++' |
		И из выпадающего списка с именем "КомандаОткрытияФичиВТекстовомРедакторе" я выбираю точное значение 'Notepad++'
	Иначе	
		И из выпадающего списка с именем "КомандаОткрытияФичиВТекстовомРедакторе" я выбираю точное значение 'Notepad++ (x64)'

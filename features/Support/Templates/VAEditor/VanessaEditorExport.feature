...
Сценарий: ДляПроверкиТочкиОстановаПодсценарий
...
Сценарий: ДляПроверкиТочкиОстановаПодсценарийF11_1

	И Я запоминаю значение выражения '1' в переменную "ИмяПеременной1"
	И Я запоминаю значение выражения '2' в переменную "ИмяПеременной2"
	И Я запоминаю значение выражения '3' в переменную "ИмяПеременной3"

Сценарий: ДляПроверкиТочкиОстановаПодсценарийF11_2
...
Сценарий: ПодсценарийСПопыткойИсключением
	* группа
		Попытка
...
Сценарий: ДляПроверкиЦикловЭкспорт01

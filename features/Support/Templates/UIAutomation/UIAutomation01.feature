...
Функциональность: Базовый тест UI Automation
...
Сценарий: Базовый тест UI Automation
	...
	* Подготовка
		...
		И в поле с именем 'Наименование' я ввожу текст 'ТестовыйЭлемент20'
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна 'Справочник2 (создание) *' в течение 20 секунд
		Тогда открылось окно 'Справочник2'
		И я нажимаю на кнопку с именем 'ФормаСоздать'
		Тогда открылось окно 'Справочник2 (создание)'
		И в поле с именем 'Наименование' я ввожу текст 'ТестовыйЭлемент21'
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна 'Справочник2 (создание) *' в течение 20 секунд
	...
	* Включение настроек
		...
		И я устанавливаю флаг настройки Vanessa Automation "ЭмулироватьДвиженияМышкиVanessaExt"
	...
	*Работа с кнопками формы		
			...
			Тогда открылось окно '1С:Предприятие'
			И я нажимаю на кнопку 'OK'
			И я нажимаю на кнопку с именем 'КнопкаСЗаголовокомСПереносомСтроки'

...
Сценарий: Запись данных ошибки из секции исключение
	* Подготовка теста
		...
		И в поле с именем 'ИмяКаталогаЛогОшибок' я ввожу текст 'C:\Temp\ЛогОшибокVA'
	...
	* Проверка файлов json ошибок
		...
		И для каждого файла "ТекущийФайл" из каталога "C:\Temp\ЛогОшибокVA"
			...
			Если '$_Расширение$ = ".json"' Тогда
				...
				Если 'Найти($ДанныеJson$.ТекстОшибки, "Не получилось сравнить таблицу с эталоном 1") > 0 И Найти($ДанныеJson$.ТекстОшибки, "Не получилось сравнить таблицу с эталоном 2") > 0' Тогда
					Тогда я вызываю исключение "В json файле найдены оба текста исключения, а должен быть только один."
				Если 'Найти($ДанныеJson$.ОписаниеОшибкиШага, "Не получилось сравнить таблицу с эталоном 1") > 0 И Найти($ДанныеJson$.ОписаниеОшибкиШага, "Не получилось сравнить таблицу с эталоном 2") > 0' Тогда
					Тогда я вызываю исключение "В json файле найдены оба текста исключения, а должен быть только один."
	...
	* Проверка дерева шагов
		...
		Тогда таблица "ДеревоТестов" стала равной:
			...
			| 'Попытка'                                                                                   | ''        |
			| 'Тогда таблица "Список" стала равной:'                                                      | 'Broken'  |
			| '\| \'Наименование\'      \|'                                                               | ''        |
			| '\| \'ТакогоЭлементаНет\' \|'                                                               | ''        |
			| 'Исключение'                                                                                | 'Failed'  |

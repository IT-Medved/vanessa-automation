...
#	И    Я открываю VanessaAutomation в режиме TestClient
	...
	И я разворачиваю группу с именем "НастройкиВидеоИнструкцийОсновные"
	И я разворачиваю группу с именем "ПараметрыЭкрана"
	И я разворачиваю группу с именем "НастройкиВидеоИнструкцийКомандыКонсоли"
	...
	И в поле с именем "ЗаписьВидеоКаталогДляВременныхФайлов" я ввожу значение из TestManager "ЗаписьВидеоКаталогДляВременныхФайлов"
	...
	И я разворачиваю группу с именем "ГруппаАудиоОбщие"
	И я разворачиваю группу с именем "ОзвучкаГолосом"

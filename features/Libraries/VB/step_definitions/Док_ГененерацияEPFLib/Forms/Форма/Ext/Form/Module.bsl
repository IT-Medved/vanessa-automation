...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВДиалогеОткрытияФайловКонфигуратораУказываю(Парам01)","ЯВДиалогеОткрытияФайловКонфигуратораУказываю","Когда я в диалоге открытия файлов конфигуратора указываю ""ИмяФайла""");

...
Функция ТабличныйДокументСоответствуетМакету(ИмяРеквизита,ИмяМакета) Экспорт
...
Функция ОбластьТабличногоДокументаСоответствуетМакету(ИмяОбласти,ИмяРеквизита,ИмяМакета,СравнениеПоШаблону = Ложь) Экспорт
	НачСтр = -1;
	НачКол = -1;
	КолСтр = -1;
	КолКол = -1;
	...
	Попытка
		//ТекстШага = "Тогда Я задаю параметры считывания макета НачСтр " + Формат(НачСтр, "ЧГ=; ЧН=0") + " НачКол  " + Формат(НачКол, "ЧГ=; ЧН=0") + "  КолСтр  " + Формат(КолСтр, "ЧГ=; ЧН=0") + "  КолКол  " + Формат(КолКол, "ЧГ=; ЧН=0");
		...
		ПолеТабличногоДокумента   = Ванесса.НайтиРеквизитОткрытойФормыПоЗаголовку(ИмяРеквизита,Истина,,,ДопПараметрыПоиска);
...
Функция ОбластьТабличногоДокументаРавнаМакету(ИмяОбласти,ИмяРеквизита,ИмяМакета) Экспорт
...
Функция ОбластьТабличногоДокументаРавнаМакетуПоШаблону(ИмяОбласти,ИмяРеквизита,ИмяМакета) Экспорт

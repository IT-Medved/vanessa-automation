...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|Для выполнения команды базы используется платформа, на которой запущен менеджер тестирования.
		|Пример:
...
Функция ЯСоздаюПустуюБазу(ПараметрыСозданияБазы) Экспорт
	...
	ВывестиСодержимоеФайлаВЖР("ЯСоздаюПустуюБазу", ФайлВывода);
...
Функция ЯЗагружаюБазуИзDT(СтрокаСоединения,ПутьКDT) Экспорт
	...
	ВывестиСодержимоеФайлаВЖР("ЯЗагружаюБазуИзDT", ФайлВывода);
...
Функция ЯВыгружаюБазуВDT(СтрокаСоединения,ПутьКDT) Экспорт
	...
	ВывестиСодержимоеФайлаВЖР("ЯВыгружаюБазуВDT", ФайлВывода);
	
КонецФункции

&НаКлиенте
Процедура ВывестиСодержимоеФайлаВЖР(ИмяСобытия, ФайлВывода)
	...
	Если Ванесса.ФайлСуществуетКомандаСистемы(ФайлВывода) Тогда
		...
		Текст.Закрыть();
		Ванесса.ЗаписатьЛогВЖРИнформация(ИмяСобытия, ТекстФайла);
	КонецЕсли;

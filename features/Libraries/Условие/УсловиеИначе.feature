...
Сценарий: Проверка предыдущего сценария "Выполняется группа в если в группе в цикле и нет шага после цикла"
...
Сценарий: Выполнение условий. Если, затем Иначе. Вариант 1.
...
Сценарий: Выполнение условий. Если, затем Иначе. Вариант 2.
	Дано Я запоминаю значение выражения "0" в переменную "СлужебнаяПеременная"
...
Сценарий: Выполнение вложенных условий. Выполняется иначе внутри другого если. Вариант 1.
	Дано Я запоминаю значение выражения "0" в переменную "СлужебнаяПеременная"
...
Сценарий: Выполнение вложенных условий. Выполняется иначе внутри другого если. Вариант 2.
	Дано Я запоминаю значение выражения "0" в переменную "СлужебнаяПеременная"

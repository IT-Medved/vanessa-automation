...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"Тогда(Парам01)","Условие","Если 'Истина' тогда","Условие. Проверяет выражение встроенного языка. В шаг передаётся один строковый параметр. Если внутри вычисляемого выражения используются строки, их нужно обрамлять кавычками. Спецсимволы (кавычки, апострофы) нужно экранировать.","Встроенный язык.Произвольное условие","Условие");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВызываюИсключение(Парам01)","ЯВызываюИсключение","Тогда я вызываю исключение ""Текст исключения""","Вызывает исключение с нужным текстом","Встроенный язык.Вызвать исключение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеЗаполнено(Парам01,Парам02)","ВТаблицеПолеЗаполнено","И в таблице ""ИмяТаблицы"" поле ""Заголовок поля"" заполнено","Проверяет заполненность ячейки таблицы. Имя ячейки указывается как оно отображено в заголовке.","UI.Таблицы.Значение ячейки таблицы");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеНеЗаполнено(Парам01,Парам02)","ВТаблицеПолеНеЗаполнено","И в таблице ""ИмяТаблицы"" поле ""Заголовок поля"" не заполнено ","Проверяет незаполненность ячейки таблицы. Имя ячейки указывается как оно отображено в заголовке.","UI.Таблицы.Значение ячейки таблицы");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеСИменемЗаполнено(Парам01,Парам02)","ВТаблицеПолеСИменемЗаполнено","И в таблице ""ИмяТаблицы"" поле с именем ""ИмяПоля"" заполнено ","Проверяет заполненность ячейки таблицы. Имя ячейки указывается как оно задано в конфигураторе.","UI.Таблицы.Значение ячейки таблицы");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеСИменемНеЗаполнено(Парам01,Парам02)","ВТаблицеПолеСИменемНеЗаполнено","И в таблице ""ИмяТаблицы"" поле с именем ""ИмяПоля"" не заполнено ","Проверяет незаполненность ячейки таблицы. Имя ячейки указывается как оно задано в конфигураторе.","UI.Таблицы.Значение ячейки таблицы");

...
Процедура УскоритьЗамедлитьФайлВидеоИДобавитьMp3(ПараметрыВидео, ИмяФайлВидео, ИмяФайлMP3, ДлительностьВидео, НоваяДлительностьВидео, ДлительностьMP3)
	...
	Иначе
		...
		ФайлMp3 = СоздатьИмяФайлаТишины(ПараметрыВидео, ДлительностьВидео + 1, ФайлИмяФайлВидео.ИмяБезРасширения + "_silence_0"); //+++ ЦВ_ПР 27.10.2025 Уменьшить длительность тишины  вместо +5 сделать +1 сек  (может быть потом через параметр задавать?)
		ДобавитьMp3КВидео(ПараметрыВидео, ИмяФайлаВидеоВременный, ФайлMp3);
	КонецЕсли;	 

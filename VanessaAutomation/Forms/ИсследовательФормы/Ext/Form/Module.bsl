...
&НаКлиенте
Процедура ЗаполнитьДанныеФормыРекурсивно(ТекущийКонтрол,ТекЭлементДерева)
...
Процедура MCPДобавитьСтрокиДереваФормы(ЭлементыДерева, Уровень, Строки)
	...
	Для Каждого ЭлементДерева Из ЭлементыДерева Цикл
		Строки.Добавить(Лев("-------------------", Уровень) + "- " + ЭлементДерева.Синоним + " [" + ЭлементДерева.Имя + "] {" + ЭлементДерева.ТипСтрока + "}");

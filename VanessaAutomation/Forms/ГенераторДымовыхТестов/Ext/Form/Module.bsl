...
Функция ПутьКФичаФайлу(СтруктураПараметров)
	...
	ПутьЗаписи = СтрШаблон(НСтр("ru = '%1%2'"), КаталогВыходныхФайловНормализованный, ИмяФичаФайла); // Пример: C:\temp\КаталогДымовыеТесты\121_Справочники_ФормаСписка.feature
...
Процедура ДобавитьТекстРасширенныеДействия(Текст, Параметры, ОбъектМетаданных, Группа = Ложь)
	...
	Если Параметры.ВидОбъектаЕЧ = "Документ" Тогда
		Если ОбъектМетаданных.Проведение = Метаданные.СвойстваОбъектов.Проведение.Разрешить Тогда
			Если Параметры.ЯзыкШагов = "ru" Тогда
				ТекстУсловие = "И ТекДанныеИсточник.Проведен И ТекДанныеИсточник.Дата > ДАТАВРЕМЯ(2024,7,1)";
			Иначе
	...
	Если Параметры.ТолькоВведенныеОбъекты Тогда
		...
		Запрос = Новый Запрос(
			...
			|ГДЕ
			|	НЕ ТекДанныеИсточник.ПометкаУдаления И ТекДанныеИсточник.Дата > ДАТАВРЕМЯ(2024,7,1)
			|	" + ТекстУсловие);
	...
	Если Параметры.ЯзыкШагов = "ru" Тогда 
		...
		|		И я создаю файл 'link.txt'  
		|			|'$НавигационнаяСсылка$'|
		|		И Я добавляю к шагу файл из 'link.txt' с типом 'txt'
		|
		...
		|			Если появилось предупреждение Тогда
		|				Тогда я вызываю исключение ""Не удалось открыть существующий элемент""" + "
		|			Если имя текущей формы ""ErrorWindow"" Тогда
		|				Тогда я вызываю исключение ""Не удалось открыть существующий элемент""" + "
	...
	Иначе
		...
		|			If the warning is displayed then
		|				Then I raise ""Could not open existing item "" exception" + "
		|			If current form name is ""ErrorWindow"" Then
		|				Then I raise ""Could not open existing item "" exception" + "
	...
	#Область Копирование	
		Если Параметры.ЯзыкШагов = "ru" Тогда
			...
			|				Если появилось предупреждение Тогда
			|					Тогда я вызываю исключение ""Не удалось скопировать существующий элемент""" + "
			|				Если имя текущей формы ""ErrorWindow"" Тогда
			|					Тогда я вызываю исключение ""Не удалось скопировать существующий элемент""" + "
			|				И я запоминаю заголовок формы в переменную 'ЗаголовокФормы'                                        
			|			Иначе 
			|				@screenshot
			|				И обратите внимание ""Нет кнопки ФормаСкопировать" + """" + "
			...
			|				Если появилось предупреждение Тогда
			|					Тогда я вызываю исключение ""Не удалось записать новый элемент""" + "
			|				Если имя текущей формы ""ErrorWindow"" Тогда
			|					Тогда я вызываю исключение ""Не удалось записать новый элемент""
			|	
			...
			|			Если появилось предупреждение Тогда
			|				Тогда я вызываю исключение ""Не удалось пометить на удаление элемент""" + "
			|			Если имя текущей формы ""ErrorWindow"" Тогда
			|				Тогда я вызываю исключение ""Не удалось пометить на удаление элемент""		
			|		");
		Иначе
			...
			|				If the warning is displayed then
			|					Then I raise ""Failed to save new item "" exception" + "
			|				If current form name is ""ErrorWindow"" Then
			|					Then I raise ""Failed to save new item "" exception")
		КонецЕсли;
	...
	#Область Запись	
		Если Параметры.ЯзыкШагов = "ru" Тогда
			...
			|				И я нажимаю на кнопку с именем 'ФормаЗаписать'
			|				Если появилось предупреждение Тогда
			|					Тогда я вызываю исключение ""Не удалось записать существующий элемент""" + "
			|				Если имя текущей формы ""ErrorWindow"" Тогда
			|					Тогда я вызываю исключение ""Не удалось записать существующий элемент""" + "
			|
			...
			|				Если появилось предупреждение Тогда
			|					Тогда я вызываю исключение ""Не удалось перечитать существующий элемент""" + "
			|				Если имя текущей формы ""ErrorWindow"" Тогда
			|					Тогда я вызываю исключение ""Не удалось перечитать существующий элемент""" + "
			|
			|		* Помечаем на удаление существующий элемент
			...
			|					И я нажимаю на кнопку с именем 'Button0'
			|				Если появилось предупреждение Тогда
			|					Тогда я вызываю исключение ""Не удалось снять пометку на удаление с элемента """ + "
			|				Если имя текущей формы ""ErrorWindow"" Тогда
			|					Тогда я вызываю исключение ""Не удалось снять пометку на удаление с элемента """);
			...
			Если Параметры.ВидОбъектаЕЧ = "Справочник"
				...
				|				Если появилось предупреждение Тогда
				|					Тогда я вызываю исключение ""Не удалось записать и закрыть элемент""" + "
				|				Если имя текущей формы ""ErrorWindow"" Тогда
				|					Тогда я вызываю исключение ""Не удалось записать и закрыть элемент""");
			...
			ИначеЕсли Параметры.ВидОбъектаЕЧ = "Документ" 
				...
				|				Если появилось предупреждение Тогда
				|					Тогда я вызываю исключение ""Не удалось провести элемент""" + "
				|				Если имя текущей формы ""ErrorWindow"" Тогда
				|					Тогда я вызываю исключение ""Не удалось провести элемент""" + "
				|
				...
				|				Если появилось предупреждение Тогда
				|					Тогда я вызываю исключение ""Не удалось отменить проведение """ + "
				|				Если имя текущей формы ""ErrorWindow"" Тогда
				|					Тогда я вызываю исключение ""Не удалось отменить проведение """ + "
				|
				...
				|				Если появилось предупреждение Тогда
				|					Тогда я вызываю исключение ""Не удалось провести и закрыть элемент""" + "
				|				Если имя текущей формы ""ErrorWindow"" Тогда
				|					Тогда я вызываю исключение ""Не удалось провести и закрыть элемент""
				|	 Иначе
				|		@screenshot
		...
		Иначе
			...
			|				And I click the button named 'ФормаЗаписать'
			|				If the warning is displayed then
			|					Then I raise ""Failed to save an existing item "" exception" + "
			|				If current form name is ""ErrorWindow"" Then
			|					Then I raise ""Failed to save an existing item "" exception" + "
			|
			...
			|				If the warning is displayed then
			|					Then I raise ""Failed to Reread an existing item "" exception" + "
			|				If current form name is ""ErrorWindow"" Then
			|					Then I raise ""Failed to Reread an existing item "" exception" + "
			|
			...
			|				If the warning is displayed then
			|					Then I raise ""Failed to Mark to delete an existing item "" exception" + "
			|				If current form name is ""ErrorWindow"" Then
			|					Then I raise ""Failed to Mark to delete an existing item"" exception" + "
			|
			...
			|					And I click the button named 'Button0'
			|				If the warning is displayed then
			|					Then I raise ""Failed to Unmark to delete an existing item "" exception" + "
			|				If current form name is ""ErrorWindow"" Then
			|					Then I raise ""Failed to Unmark to delete an existing item"" exception");
			...
			Если Параметры.ВидОбъектаЕЧ = "Справочник"
				...
				|				If the warning is displayed then
				|					Then I raise ""Failed to Save and close an existing element "" exception" + "
				|				If current form name is ""ErrorWindow"" Then
				|					Then I raise ""Failed to Save and close an existing element "" exception");
			...
			ИначеЕсли Параметры.ВидОбъектаЕЧ = "Документ" 
				...
				|				If the warning is displayed then
				|					Then I raise ""Failed to Posting document "" exception" + "
				|				If current form name is ""ErrorWindow"" Then
				|					Then I raise ""Failed to Posting document "" exception" + "
				|
				...
				|				If the warning is displayed then
				|					Then I raise ""Failed to Cancel Posting the document "" exception" + "
				|				If current form name is ""ErrorWindow"" Then
				|					Then I raise ""Failed to Cancel Posting the document "" exception" + "
				|
				...
				|				If the warning is displayed then
				|					Then I raise ""Failed to Posting and close the document "" exception" + "
				|				If current form name is ""ErrorWindow"" Then
				|					Then I raise ""Failed to Posting and close the document "" exception");
	...
	#Область ВводНаОсновании
		...
		Для Каждого ПодчиненныйОбъект Из ПодчиненныеОбъекты Цикл
			...
			Если Параметры.ЯзыкШагов = "ru" Тогда
				...
				|				Если появилось предупреждение Тогда
				|					Тогда я вызываю исключение ""Не удалось ввести " + ИмяГруппы + " на основании 
				|				Если имя текущей формы ""ErrorWindow"" Тогда
				|					Тогда я вызываю исключение ""Не удалось ввести " + ИмяГруппы + " на основании 
			...
			Иначе
				...
				|				If the warning is displayed then
				|					Then I raise ""Failed to Generate " + ИмяГруппы + " based on "" exception" + " 
				|				If current form name is ""ErrorWindow"" Then
				|					Then I raise ""Failed to Generate " + ИмяГруппы + " based on "" exception" + "
	...
	#Область Печать
		...
		Для Каждого КомандаПечати Из КомандыПечати Цикл
			...
			Иначе
				...
				|				And I click the button named '" + ИмяКоманды + "'
				|				If the warning is displayed then
				|					Then I raise ""Failed to print form """ + ИмяГруппы + """ "" exception" + " 
				|				If current form name is ""ErrorWindow"" Then
				|					Then I raise ""Failed to print form """ + ИмяГруппы + """ "" exception" + "

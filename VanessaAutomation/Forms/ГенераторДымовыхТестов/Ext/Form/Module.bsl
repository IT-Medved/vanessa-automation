...
Процедура СформироватьФайлыСценариевТестирования()
	...
	СтруктураПараметров = СтруктураПараметровГенерацииСценариев(ЯзыкШагов, ВариантВстроенногоЯзыка);
...
Функция СтруктураПараметровГенерацииСценариев(ЯзыкШагов, ВариантВстроенногоЯзыка)
...
Процедура ДобавитьТекстРасширенныеДействия(Текст, Параметры, ОбъектМетаданных, Группа = Ложь)
	...
	Если Параметры.ЯзыкШагов = "ru" Тогда 
		...
		Текст.ДобавитьСтроку("
		|Сценарий: " + Параметры.ТипТеста + " элемента " + ?(Группа, "группы ", "") + Параметры.ВидОбъектаРП + " """ + ОбъектМетаданных.Синоним + """ (" + ОбъектМетаданных.Имя + ") // BSLLS-off
		|

...
Процедура СформироватьФайлыСценариевТестирования()
	...
	СтруктураПараметров = СтруктураПараметровГенерацииСценариев(ЯзыкШагов, ВариантВстроенногоЯзыка, Объект.ДымовыеТестыНачальнаяДатаДляПодбораДокументов);
...
Функция СтруктураПараметровГенерацииСценариев(ЯзыкШагов, ВариантВстроенногоЯзыка, ДымовыеТестыНачальнаяДатаДляПодбораДокументов)
...
Процедура СформироватьСценарииПоМетаданнымНаСервере()
	...
	// Инициализируем базовые параметры.
	СтруктураПараметров = СтруктураПараметровГенерацииСценариев(ЯзыкШагов, ВариантВстроенногоЯзыка, ДымовыеТестыНачальнаяДатаДляПодбораДокументов);
	СтруктураПараметров.ТолькоВведенныеОбъекты = ТолькоВведенныеОбъекты;
...
Процедура ДобавитьТекстРасширенныеДействия(Текст, Параметры, ОбъектМетаданных, Группа = Ложь)
	...
	Если Параметры.ЯзыкШагов = "ru" Тогда 
		...
		|				|ГДЕ
		|				|	НЕ ТекДанныеИсточник.ПометкаУдаления
		|				|	" + ТекстУсловие + """);" + СтрокаУстановкиПараметра + "

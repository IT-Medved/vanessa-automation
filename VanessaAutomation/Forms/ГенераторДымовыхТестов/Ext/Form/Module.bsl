...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ДымовыеТестыНачальнаяДатаДляПодбораДокументов") 
	    ...
	    Объект.ДымовыеТестыНачальнаяДатаДляПодбораДокументов = Параметры.ДымовыеТестыНачальнаяДатаДляПодбораДокументов;
	Иначе
...
Функция СтруктураПараметровГенерацииСценариев(ЯзыкШагов, ВариантВстроенногоЯзыка)
	...
	СтруктураПараметров.Вставить("ДымовыеТестыНачальнаяДатаДляПодбораДокументов", Объект.ДымовыеТестыНачальнаяДатаДляПодбораДокументов);

...
Функция КоллекцияКомандЗапуска() Экспорт
	...
	КоллекцияКоманд.Вставить("ДымовыеТестыНачальнаяДатаДляПодбораДокументов", Новый Структура("Р, А", "ДымовыеТестыНачальнаяДатаДляПодбораДокументов", "StartingDateForSelectionDocuments"));
